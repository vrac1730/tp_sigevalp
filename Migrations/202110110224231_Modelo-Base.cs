namespace SIGEVALP.Migrations
{
    ...
    public partial class ModeloBase : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ProductoxAlmacen_id = c.Int(),
                    })
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.ProductoAlmacen", t => t.ProductoxAlmacen_id)
                .Index(t => t.ProductoxAlmacen_id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.HistorialMovimientoes", "ProductoxAlmacen_id", "dbo.ProductoAlmacen");
            ...
            DropIndex("dbo.HistorialMovimientoes", new[] { "ProductoxAlmacen_id" });
